      ...
      <a href="${ROOT}index.html" class="logo">
        <div class="logo-icon">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2L4 6v6c0 5.5 3.4 10.7 8 12 4.6-1.3 8-6.5 8-12V6L12 2zm0 3.2l5 2.5V12c0 3.8-2.3 7.3-5 8.6-2.7-1.3-5-4.8-5-8.6V7.7l5-2.5z"/>
            <path d="M10 11l-2 2 3 3 5-5-2-2-3 3z"/>
          </svg>
        </div>
        <div class="logo-text">
          <span class="logo-name">רויאל-מד ישראל</span>
          <span class="logo-sub">מרכז רפואי לאסתטיקה מתקדמת</span>
        </div>
      </a>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <div class="social-links">
          ...
          <a href="#" class="social-link" aria-label="אינסטגרם">
          ...
          <a href="#" class="social-link" aria-label="טיקטוק">
