...
const TRANSLATIONS = {
  he: {
    ...
    'btn.more': 'למידע נוסף',
    // HERO
    'hero.tag': 'מרכז רפואי מתקדם לאסתטיקה',
    'hero.title': 'מרכז רפואי מתקדם לאסתטיקה מבוססת ביורגנרציה',
    'hero.sub': 'רויאל-מד ישראל היא מרכז רפואי המתמחה בטיפולים אסתטיים מבוססי ביורגנרציה. פועלים לפי סטנדרטים רפואיים גבוהים, טכנולוגיות מתקדמות והתאמה אישית לכל מטופל.',
  ...
  en: {
    ...
    'btn.more': 'Learn More',
    'hero.tag': 'Advanced Medical Aesthetics Center',
    'hero.title': 'Advanced Medical Center for Bioregeneration-Based Aesthetics',
    'hero.sub': 'Royal-Med Israel specializes in aesthetic treatments based on bioregeneration. We operate according to high medical standards, advanced technologies, and personalized care for each patient.',
  ...
  ar: {
    ...
    'hero.tag': 'مركز طبي متقدم للتجميل',
    'hero.title': 'مركز طبي متقدم للتجميل القائم على التجديد البيولوجي',
    'hero.sub': 'رويال-ميد إسرائيل متخصص في علاجات التجميل القائمة على التجديد البيولوجي. نعمل وفق معايير طبية عالية وتقنيات متطورة مع تخصيص شخصي لكل مريض.',
  ...
  ru: {
    ...
    'hero.tag': 'Передовой медицинский центр эстетики',
    'hero.title': 'Передовой медицинский центр эстетики на основе биорегенерации',
    'hero.sub': 'Royal-Med Israel специализируется на эстетических процедурах на основе биорегенерации. Мы работаем по высоким медицинским стандартам с применением передовых технологий и индивидуальным подходом.',
